...
export const translations = {
  ...
  meetAI: {
    label: { en: "Meet Fin AI", fr: "Découvrez Fin AI" },
    title: { en: "The intelligence layer behind every decision", fr: "La couche d'intelligence derrière chaque décision" },
    desc: {
      en: "Fin AI is the engine FinSupport is built on. Trained on real support signals — it classifies, routes, monitors, and resolves so your team can focus on complex issues.",
      fr: "Fin AI est le moteur sur lequel FinSupport est construit. Entraîné sur de vrais signaux de support — il classe, route, surveille et résout pour que votre équipe puisse se concentrer sur les problèmes complexes.",
    },
  },
  security: {
    ...
    desc: {
      en: "FinSupport is built to meet data protection, financial regulation, and compliance requirements of banks, fintechs, and institutions globally.",
      fr: "FinSupport est conçu pour répondre aux exigences de protection des données, de réglementation financière et de conformité des banques, fintechs et institutions du monde entier.",
    },
  },
  integrations: {
    ...
    desc: {
      en: "Connect FinSupport to your existing tools in minutes — communication channels, automation platforms, cloud services, and CRMs. No rip-and-replace.",
      fr: "Connectez FinSupport à vos outils existants en quelques minutes — canaux de communication, plateformes d'automatisation, services cloud et CRM. Pas de remplacement.",
    },
    apiCta: { en: "Explore the API", fr: "Explorer l'API" },
    noTool: { en: "Don't see your tool? FinSupport exposes a full REST API — connect anything in your stack.", fr: "Vous ne voyez pas votre outil? FinSupport expose une API REST complète — connectez n'importe quoi dans votre pile." },
  },
  cta: {
    ...
    desc: { en: "Every ticket is a promise. FinSupport makes sure you keep it.", fr: "Chaque ticket est une promesse. FinSupport s'assure que vous la tenez." },
  ...
  channelsPage: {
    ...
    developer: {
      ...
      desc: { en: "FinSupport provides a clean, intuitive API that makes channel integration effortless. One endpoint per channel, consistent response formats, and comprehensive documentation.", fr: "FinSupport fournit une API propre et intuitive qui rend l'intégration des canaux sans effort. Un endpoint par canal, formats de réponse cohérents et documentation complète." },
  ...
  aboutPage: {
    title: { en: "About FinSupport", fr: "À propos de FinSupport" },
    ...
    mission: {
      ...
      desc: { en: "FinSupport empowers businesses to deliver exceptional customer experiences through intelligent automation. We believe every customer interaction is an opportunity to build trust, and AI is the key to making that happen at scale.", fr: "FinSupport permet aux entreprises d'offrir des expériences client exceptionnelles grâce à l'automatisation intelligente. Nous croyons que chaque interaction client est une occasion de bâtir la confiance." },
    },
    values: {
    ...
    story: {
      ...
      p1: { en: "Founded in Nigeria, FinSupport was born from the frustration of managing customer support across too many channels. We watched businesses struggle with fragmented tools, missed tickets, and unhappy customers.", fr: "Fondée au Nigéria, FinSupport est née de la frustration de gérer le support client sur trop de canaux. Nous avons vu des entreprises lutter avec des outils fragmentés." },
      p2: { en: "We built the platform we wished existed — a single place where AI handles the repetitive work, agents focus on what matters, and no customer ever feels ignored. Today, FinSupport powers support for hundreds of teams across Africa and beyond.", fr: "Nous avons construit la plateforme que nous aurions aimé voir exister — un endroit où l'IA gère le travail répétitif et aucun client ne se sent jamais ignoré." },
    ...
    numbers: {
      ...
      teams: { en: "Teams Using FinSupport", fr: "Équipes utilisant FinSupport" },
  ...
  landing: {
    ...
    steps: {
      ...
      classify: { title: { en: "Classify", fr: "Classification" }, desc: { en: "Fin AI detects intent, sentiment, and urgency in under 50ms. Routes to the right queue.", fr: "Fin AI détecte l'intention, le sentiment et l'urgence en moins de 50ms. Route vers la bonne file." } },
  ...
  misc: {
    poweredBy: { en: "FinSupport-powered delivery", fr: "Livraison propulsée par FinSupport" },
  ...
  footer: {
    desc: { en: "AI-powered customer support platform. Built by FinSupport for teams that move fast.", fr: "Plateforme de support client alimentée par l'IA. Construite par FinSupport pour les équipes qui avancent vite." },
    ...
    copyright: { en: "© 2026 FinSupport. All rights reserved.", fr: "© 2026 FinSupport. Tous droits réservés." },
  },
  loginPage: {
    ...
    testimonial: { en: "FinSupport cut our response time by 73% and our team can focus on complex issues instead of repetitive questions.", fr: "FinSupport a réduit notre temps de réponse de 73% et notre équipe peut se concentrer sur les problèmes complexes." },
    testimonialRole: { en: "Head of Support, FinSupport", fr: "Directeur du Support, FinSupport" },
  ...
  dashboardPage: {
    ...
    welcomeBack: { en: "Welcome back, {name}. Here's your FinSupport overview.", fr: "Bon retour, {name}. Voici votre aperçu FinSupport." },
    export: { en: "Export", fr: "Exporter" },
