...
const team = [
  ...
  },
  {
    ...
    fullBio: "Emeka brings deep expertise in natural language processing and machine learning infrastructure. Before joining FinSupport, he spent 6 years at Google AI working on multilingual NLP models used by millions. He holds a PhD in Computer Science from the University of Oxford and has published 15+ papers on transformer architectures and sentiment analysis. At FinSupport, he leads the AI agent pipeline that classifies, routes, and resolves 67% of tickets autonomously. He is passionate about making AI accessible to African businesses.",
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#0b1a2e] via-[#0f2340] to-[#142d50]">
        ...
        <div className="max-w-[1200px] mx-auto px-6 py-28 sm:py-36 text-center relative">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/10 mb-8">
            ...
            <span className="text-[13px] font-semibold text-blue-300 uppercase tracking-wider">{t("aboutPage.title") || "About FinSupport"}</span>
          </div>
          <h1 className="text-[40px] sm:text-[56px] lg:text-[68px] font-extrabold leading-[0.95] tracking-tight text-white mb-6">
            {t("aboutPage.title") || "About FinSupport"}{" "}
            <span className="italic text-blue-400">FinSupport</span>
          </h1>
      ...
      <section className="max-w-[1200px] mx-auto px-6 py-24">
        <RevealSection className="text-center mb-16">
          ...
          <p className="text-gray-500 text-lg max-w-3xl mx-auto leading-relaxed">
            {t("aboutPage.mission.desc") || "FinSupport empowers financial institutions to deliver exceptional customer experiences through intelligent automation."}
          </p>
        </RevealSection>
      </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-gray-300/80 text-lg leading-relaxed mb-6">
                  {t("aboutPage.story.p1") || "Founded in Nigeria, FinSupport was born from the frustration of managing customer support across too many channels."}
                </p>
      ...
      <section className="max-w-[1200px] mx-auto px-6 py-24">
        <RevealSection className="text-center mb-16">
          ...
          <h2 className="text-[36px] sm:text-[48px] font-extrabold tracking-tight leading-[1.05]">
            ...
            <span className="italic text-blue-600">FinSupport</span>
          </h2>
        </RevealSection>
        ...
        <div className="max-w-[800px] mx-auto px-6 text-center relative">
          <RevealSection>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a href="mailto:careers@finsupport.com" className="inline-flex items-center gap-2 px-10 py-4 bg-transparent border-2 border-blue-400/40 text-blue-300 rounded-full text-[15px] font-semibold hover:bg-blue-400/10 transition-all">
