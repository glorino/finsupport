        ...
        <div className="prose prose-gray max-w-none space-y-8">
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              By accessing or using FinSupport (the &quot;Service&quot;), you agree to be bound by these Terms &amp; Conditions (&quot;Terms&quot;). If you do not agree to these Terms, do not use the Service. These Terms constitute a legally binding agreement between you (&quot;you,&quot; &quot;your,&quot; or &quot;User&quot;) and FinSupport (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;).
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              FinSupport is an AI-powered financial support platform that provides:
            </p>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              The Service and its original content, features, and functionality are owned by FinSupport and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws. You may not copy, modify, distribute, sell, or lease any part of the Service without our express written permission.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              To the maximum extent permitted by law, FinSupport shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenue, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses resulting from:
            </p>
            <ul className="list-disc list-inside text-gray-600 mt-2 space-y-1">
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              You agree to indemnify, defend, and hold harmless FinSupport and its officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including legal fees) arising from your use of the Service or violation of these Terms.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="mt-3 p-4 bg-gray-50 rounded-xl">
              <p className="text-gray-700 font-medium">FinSupport</p>
