...
export default function LoginPage() {
  ...
  const demoLogins = [
    { email: "emeka@finsupport.com", role: t("roles.superAdmin"), name: "Dr. Chukwuemeka Obi", avatar: "CO", gradient: "from-violet-500 to-indigo-600" },
    { email: "folake@finsupport.com", role: t("roles.manager"), name: "Folake Ogundipe", avatar: "FO", gradient: "from-emerald-500 to-teal-600" },
    { email: "ngozi@finsupport.com", role: t("roles.agent"), name: "Ngozi Okolo", avatar: "NO", gradient: "from-blue-500 to-cyan-600" },
    { email: "dayo@finsupport.com", role: t("roles.viewer"), name: "Dayo Fadugba", avatar: "DF", gradient: "from-gray-500 to-slate-600" },
  ];
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  placeholder="you@finsupport.com"
                  required
