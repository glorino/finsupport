            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <RevealSection>
                ...
                <p className="text-gray-500 text-lg leading-relaxed mb-8">
                   {t("channelsPage.developer.desc") || "FinSupport provides a clean, intuitive API that makes channel integration effortless. One endpoint per channel, consistent response formats, and comprehensive documentation."}
                </p>
              ...
              <RevealSection delay={100}>
                <div className="bg-[#0d1117] rounded-2xl overflow-hidden border border-gray-800 shadow-2xl">
                  ...
                  <pre className="p-6 text-sm font-mono text-gray-300 overflow-x-auto leading-relaxed">
                    <code>{`import { FinSupport } from '@finsupport/sdk';

const finsupport = new FinSupport({
  apiKey: 'your-api-key'
});

// ${t("channelsPage.developer.commentWhatsApp") || "Connect WhatsApp channel"}
await finsupport.channels.connect({
  type: 'whatsapp',
  phone: '+234801234567',
...
const status = await finsupport.channels.list();
