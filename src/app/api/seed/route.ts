...
const demoUsers = [
  { email: "admin@finsupport.com", password: "admin123", name: "Alex Johnson", role: "super_admin", team: "AI Operations" },
  { email: "marcus@finsupport.com", password: "demo123", name: "Marcus Johnson", role: "admin", team: "Support Engineering" },
  { email: "sarah@finsupport.com", password: "demo123", name: "Sarah Kim", role: "manager", team: "Billing & Accounts" },
  { email: "emily@finsupport.com", password: "demo123", name: "Emily Rodriguez", role: "manager", team: "Customer Success" },
  { email: "tom@finsupport.com", password: "demo123", name: "Tom Chen", role: "agent", team: "Support Engineering" },
  { email: "lisa@finsupport.com", password: "demo123", name: "Lisa Park", role: "agent", team: "Support Engineering" },
  { email: "david@finsupport.com", password: "demo123", name: "David Kim", role: "agent", team: "Billing & Accounts" },
  { email: "rachel@finsupport.com", password: "demo123", name: "Rachel Green", role: "agent", team: "Customer Success" },
  { email: "mike@finsupport.com", password: "demo123", name: "Mike Davis", role: "agent", team: "Support Engineering" },
  { email: "viewer@finsupport.com", password: "demo123", name: "Jordan Lee", role: "viewer", team: null },
];
...
const demoKnowledgeArticles = [
  ...
  { title: "How to Upgrade or Downgrade Your Plan", content: "To change your plan, go to Settings > Billing > Subscription. Click 'Change Plan' and select your desired tier. Upgrades take effect immediately and you'll be charged a prorated amount. Downgrades take effect at the end of your current billing cycle. All plan features are listed on our pricing page. Contact sales@finsupport.com for Enterprise custom plans.", collection: "Account & Billing", status: "published", views: 1567, ai_used: 112, helpful: 90, tags: ["plan", "upgrade", "downgrade", "subscription", "pricing"] },
  { title: "Requesting a Refund", content: "We offer refunds within 14 days of purchase if you're unsatisfied. To request a refund, email billing@finsupport.com with your account email, invoice number, and reason for the refund. Refunds are processed within 5-7 business days to your original payment method. Note: refunds are not available for partial month usage after the 14-day window.", collection: "Account & Billing", status: "published", views: 743, ai_used: 54, helpful: 85, tags: ["refund", "billing", "money-back"] },
  ...
  { title: "Understanding Sentiment Analysis", content: "FinSupport's sentiment agent analyzes every message in real-time, detecting emotions like positive, neutral, negative, angry, and frustrated. Sentiment scores range from -1 (very negative) to +1 (very positive). The system uses natural language processing trained on customer support data. Sentiment trends are tracked over time to identify patterns. Use sentiment data to prioritize at-risk customers and improve response strategies.", collection: "Technical Docs", status: "published", views: 2345, ai_used: 189, helpful: 91, tags: ["sentiment", "ai", "analysis", "nlp"] },
  { title: "REST API Documentation Overview", content: "FinSupport provides a comprehensive REST API for programmatic access. Base URL: https://api.finsupport.com/v1. Authentication: Bearer token in Authorization header. Key endpoints: /tickets (CRUD), /customers (CRUD), /knowledge (search), /analytics (reports). Rate limits: 1000 requests/minute. Full documentation at docs.finsupport.com/api. SDKs available for Node.js, Python, PHP, and Go.", collection: "API Reference", status: "published", views: 4567, ai_used: 345, helpful: 93, tags: ["api", "rest", "documentation", "developers"] },
  ...
  { title: "Data Export and Privacy Compliance", content: "FinSupport is GDPR and NDPR compliant. Export your data anytime from Settings > Data > Export. Available formats: CSV, JSON, XML. Exports include tickets, customers, conversations, and analytics. Data retention: 90 days for messages, 1 year for tickets, indefinite for knowledge base. To request data deletion, email privacy@finsupport.com. Audit logs track all data access.", collection: "Technical Docs", status: "published", views: 1234, ai_used: 89, helpful: 90, tags: ["gdpr", "privacy", "data", "compliance", "export"] },
...
export async function POST() {
  try {
    ...
    for (let i = 0; i < demoTickets.length; i++) {
      ...
      const assigneeId = userIdMap["tom@finsupport.com"];
    ...
    const adminUserId = userIdMap["admin@finsupport.com"];
    ...
    return NextResponse.json({
      ...
      logins: {
        admin: "admin@finsupport.com / admin123",
        manager: "sarah@finsupport.com / demo123",
        agent: "tom@finsupport.com / demo123",
        viewer: "viewer@finsupport.com / demo123",
      },
    });
  } catch (error) {
