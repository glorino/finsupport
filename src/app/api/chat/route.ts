...
export async function POST(req: Request) {
  ...
  if (!apiKey) {
    ...
    if (fuzzyMatch(lowerMsg, ["password", "reset", "login", "forgot", "locked"])) {
      ...
      response = "Hello! Welcome to FinSupport. I'm here to help you with any questions about our platform.\n\nI can assist with:\n• Account and billing questions\n• Technical support\n• Feature inquiries\n• Ticket creation\n\nHow can I help you today?";
    } else {
  ...
  const result = streamText({
    model: openai("gpt-4o"),
    system: `You are Fin AI, the intelligent customer support assistant for FinSupport.
...
Always verify facts before providing solutions. If uncertain, escalate to a human agent.`,
    ...
    tools: {
      ...
      lookupTicket: tool({
        description: "Look up a ticket by its ticket number (e.g. FIN-1234)",
        inputSchema: z.object({
          ticketNumber: z.string().describe("Ticket number like FIN-1234"),
        }),
