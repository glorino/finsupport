      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.06);">
        <tr>
          <td style="background:linear-gradient(135deg,#1e40af,#3b82f6);padding:32px 40px;">
            ...
            <p style="color:#bfdbfe;margin:6px 0 0;font-size:14px;">FinSupport</p>
          </td>
        </tr>
        <tr>
          <td style="padding:36px 40px;">
            ...
            <p style="font-size:14px;color:#6b7280;line-height:1.6;margin:0 0 20px;">
              A calendar invite and meeting link will be sent to you shortly. The demo is a 30-minute walkthrough of FinSupport, customized to your industry and team size. No commitment required.
            </p>
        ...
        <tr>
          <td style="padding:20px 40px;border-top:1px solid #f3f4f6;">
            <p style="font-size:12px;color:#9ca3af;margin:0;text-align:center;">
              © ${new Date().getFullYear()} FinSupport — AI-Powered Financial Support Platform
            </p>
          </td>
        </tr>
      </table>
