    ...
    <aside className="fixed inset-y-0 left-0 z-40 w-[268px] border-r border-gray-200/60 bg-white/80 backdrop-blur-2xl hidden lg:flex flex-col">
      ...
      <div className="flex h-[68px] items-center gap-3 border-b border-gray-100/80 px-5">
        <Link href="/dashboard" className="flex items-center gap-2.5 group">
          <img src="/logo.svg" alt="FinSupport" className="h-9 w-9 group-hover:scale-105 transition-transform duration-300" />
          <div>
            <span className="text-lg font-bold text-gray-900 tracking-tight">FinSupport</span>
          </div>
        </Link>
      </div>
      ...
      <div className="px-3 pb-3">
        <a
          href="https://finsupport.vercel.app"
          target="_blank"
