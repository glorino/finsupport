        ...
        <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 px-6 py-5 relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-100 text-sm mt-0.5">See FinSupport in action — tailored to your team</p>
            </div>
        ...
        {step === "success" ? (
          <div className="p-8 text-center">
            ...
            <div className="bg-blue-50 rounded-2xl p-4 border border-blue-100 mb-6">
              ...
              <p className="text-sm text-gray-600 mt-1">A 30-minute walkthrough of FinSupport, customized to your industry and team size. No commitment required.</p>
            </div>
